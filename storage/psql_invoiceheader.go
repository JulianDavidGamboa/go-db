...
const (
	...
	psqlCreateInvoiceHeader = `INSERT INTO go_db.invoice_headers(client) VALUES ($1)
...
func (p *PsqlInvoiceHeader) Migrate() error {
	...
	log.Println("Migración de invoice header ejecutada correctamente")

	return nil
}

// CreateTx implemet the interface invoiceitem.Storage
